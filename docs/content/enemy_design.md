...
- **定位**：远程爆发型 BOSS
- **被动 `enemy_crystal_charge`**：普攻命中时额外恢复 8 魔力，高频技能释放
- **主动 `enemy_crystal_beam`**：造成 320% 攻击力技能伤害，对半血以下目标伤害提高
- **设计要点**：高攻击（42）高暴击（15% / x1.80），射程 170，低生命（620）适合刺客切入；快速回魔导致技能频率极高

### 哥布林大祭司 / Goblin High Priest

- **定位**：团队续航与增幅型 BOSS
- **被动 `enemy_goblin_chant`**：战斗开始时敌方全队获得 30 护盾和 +10% 魔力回复
- **主动 `enemy_goblin_benediction`**：敌方全队治疗 25 + 120% 攻击力并获得 50 护盾
